...
public class entityResolver
{
    ...
    public static void main(String[] args){
        entityResolver a=new entityResolver();
        int p=a.entity_resolution_checker("wei wang","tzone i. wang");
        System.out.print(p);
    }
    ...
    public int entity_resolution_checker(String one,String two) {
        ...
        if (one.equals(two)) {return 1;}
            ...
            if (second==1 | third==1 |fourth==1 |fifth==1){return 1;}}
        return 0;}
    ...
    public void reset(){
        first_char_first_sting_last_name = ' ';
        first_char_second_sting_last_name = ' ';
        second_char_first_sting_last_name = ' ';
        second_char_second_sting_last_name = ' ';
        first_char_first_string_middle_name = ' ';
        first_char_second_string_middle_name = ' ';
        second_char_first_string_middle_name = ' ';
        second_char_second_string_middle_name = ' ';
    }
}
